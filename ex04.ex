...
defmodule Ex04 do
  ...
  def odd_even(x, {e, o} ) when Integer.is_odd(x), do: {e, o ++ [x]}
  def odd_even(x, {e, o} ) when Integer.is_even(x), do: {e ++ [x], o }
  
  def even_odd([]), do: { [ ], [ ] }
  def even_odd(x), do: reduce(x, { [ ], [ ] }, &(odd_even(&1, &2)))
