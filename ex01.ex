...
defmodule Ex01 do
  ...
  sum2a = fn(number1, number2) -> number1 + number2 end
  ...
  sum3a = fn(number1, number2, number3) -> sum2a.(number1, sum2a.(number2, number3)) end
  ...
  create_adder = fn(number1) ->
      fn(number2) -> number1 + number2 end
    end
